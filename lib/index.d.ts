...
export declare function fn(n: string): Value;
export declare function va(n: string): Expression;
export declare function add(x: Expression, y: Expression): Expression;
export declare function sub(x: Expression, y: Expression): Expression;
export declare function mul(x: Expression, y: Expression): Expression;
export declare function div(x: Expression, y: Expression): Expression;
