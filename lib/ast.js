...
exports.evaluationErrorToString = exports.va = exports.t = exports.n = exports.l = exports.stringifyStatement = exports.stringifyExpression = exports.stringifyIdentifier = exports.stringifyValue = exports.addOutputToEnvironment = exports.createOutput = exports.isTruthy = exports.runStatementSafely = exports.runStatement = exports.getStringValue = exports.evaluateExpressionSafely = exports.evaluateExpressionSafelyCurried = exports.evaluateExpression = exports.evaluateIdentifierSafely = exports.evaluateIdentifier = exports.schemaStatement = exports.schemaExpression = exports.schemaIdentifier = exports.schemaValue = void 0;
// AST
...
const schemaEnvironment = zod_1.z.object({
...
function runStatement(environment, statement) {
    return E.match((e) => {
        throw new Error(evaluationErrorToString(e));
    }, (v) => v)(runStatementSafely(environment, statement));
}
exports.runStatement = runStatement;
function runStatementSafelyCurried(environment) {
    return (statement) => runStatementSafely(environment, statement);
}
function runStatementSafely(environment, statement) {
    return (0, ts_pattern_1.match)(statement)
        ...
        .with({ type: "proc_run" }, ({ identifier, args }) => (0, function_1.pipe)(E.of(runStatementSafelyCurried), E.ap(environmentWithArgs(args, environment)), E.ap((0, function_1.pipe)(evaluateIdentifierSafely(environment, identifier), E.chainW(getProcedure(environment)))), E.flatten))
