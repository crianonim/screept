...
(function (TokenKind) {
    ...
    TokenKind[TokenKind["Emit"] = 17] = "Emit";
    TokenKind[TokenKind["Comma"] = 18] = "Comma";
    TokenKind[TokenKind["LBracket"] = 19] = "LBracket";
    TokenKind[TokenKind["RBracket"] = 20] = "RBracket";
    TokenKind[TokenKind["SemiColon"] = 21] = "SemiColon";
    TokenKind[TokenKind["Func"] = 22] = "Func";
    TokenKind[TokenKind["If"] = 23] = "If";
    TokenKind[TokenKind["Then"] = 24] = "Then";
    TokenKind[TokenKind["Else"] = 25] = "Else";
    TokenKind[TokenKind["Not"] = 26] = "Not";
    TokenKind[TokenKind["NewLine"] = 27] = "NewLine";
    TokenKind[TokenKind["ProcDef"] = 28] = "ProcDef";
    TokenKind[TokenKind["ProcRun"] = 29] = "ProcRun";
    TokenKind[TokenKind["Rnd"] = 30] = "Rnd";
    TokenKind[TokenKind["Equal"] = 31] = "Equal";
    TokenKind[TokenKind["Greater"] = 32] = "Greater";
    TokenKind[TokenKind["LessThan"] = 33] = "LessThan";
})(TokenKind || (TokenKind = {}));
...
}), (0, typescript_parsec_3.apply)((0, typescript_parsec_3.seq)((0, typescript_parsec_3.tok)(TokenKind.Emit), CONDITIONAL_EXP), ([t1, value]) => {
